			...
			<div className="input-form-container">
				<div className="table">
					...
					<div className="copy-button">
						<Clipboard 
							data-clipboard-text={
								`${lot}\t${''}\t${doping}\t${sosungNo}\t${sizing}\t${jigwanStatistics.avg}\t${jigwanStatistics.std}\t${jigwanStatistics.cv}\t${jigwanStatistics.max}\t${jigwanStatistics.min}\t ${gaesumStatistics.avg}\t${gaesumStatistics.std}\t${gaesumStatistics.cv}\t${jigwanStatistics.max}\t${jigwanStatistics.min}`
							}
